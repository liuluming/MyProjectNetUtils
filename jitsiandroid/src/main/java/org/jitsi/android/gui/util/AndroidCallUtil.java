...
public class AndroidCallUtil
{
    ...
    public  static ContactModel isExist(String tel) {
        List<ContactModel> contactModels = DataSupport.findAll(ContactModel.class);
        if(contactModels!=null){
            for(ContactModel contactModel:contactModels){
                if(contactModel.getPhoneNumber().equals(tel)){
                    return contactModel;
                }
            }
        }
    ...
    private static void sendCallendBroadCast(Context context) {
        Intent intent = new Intent();
        intent.setAction("end_call");
        intent.putExtra("call_times", "");
