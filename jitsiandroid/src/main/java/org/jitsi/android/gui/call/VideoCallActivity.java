...
import org.jitsi.android.gui.widgets.ClickableToastController;
import org.jitsi.android.gui.widgets.LegacyClickableToastCtrl;
...
public class VideoCallActivity
    ...
    private void initHangupView() {
        ...
        hangupView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(call!=null&&!statusName.getText().toString().equals(getString(R.string.service_gui_FAILED_STATUS))){
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        TextView statusName = (TextView) findViewById(R.id.callStatus);
                        if(!statusName.getText().toString().equals(getString(R.string.service_gui_FAILED_STATUS)))
                        {
    ...
    private void sendCallendBroadCast() {
        ...
        intent.putExtra("call_times", callState.callDuration);
    ...
    public void setPeerState(CallPeerState oldState, CallPeerState newState,
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                TextView statusName = (TextView) findViewById(R.id.callStatus);
                if(stateString.equals("Call failed")){
                    statusName.setText(getString(R.string.service_gui_FAILED_STATUS));
                }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.low_resolution) {
            return true;
        } else if (i == R.id.high_resolution) {
            return true;
        } else if (i == R.id.call_info_item) {
            showCallInfoDialog();
            return true;
        } else if (i == R.id.call_zrtp_info_item) {
            showZrtpInfoDialog();
            return true;
        } else {
    ...
    /**
     * Invoked by {@link #} to notify this instance about
