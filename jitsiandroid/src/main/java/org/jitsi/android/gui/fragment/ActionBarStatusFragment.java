               ...
               GlobalDisplayDetailsListener
{
        ...
        activity.runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ActionBarUtil.setSubtitle(
                        activity,
                        getSattusCNName(presenceStatus.getStatusName()));
    ...
    private String getSattusCNName(String statusName) {
        if("Online".equals(statusName)){
            globalStatusMenu.setOnlineImage(R.drawable.global_online);
            globalStatusMenu.setOfflineImage(R.drawable.global_offline);
            return getResources().getString(R.string.service_gui_ONLINE);
        }else if("Offline".equals(statusName)){
            globalStatusMenu.setOnlineImage(R.drawable.global_offline);
            globalStatusMenu.setOfflineImage(R.drawable.global_online);
            return getResources().getString(R.string.service_gui_OFFLINE);
        }
        return "未知状态";
    }
