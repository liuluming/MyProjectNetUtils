                ...
                OnGroupClickListener
{
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        ...
        if (i == R.id.re_request_auth) {
            ...
            return true;
        } else if (i == R.id.close_all_chats) {
            onCloseAllChats();
            return true;
        }
