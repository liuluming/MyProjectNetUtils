...
public class MyListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        setCacheColorHint(context.getResources().getColor(R.color.item_gray_color));
    ...
    public void setTopRefresh(Boolean b){
        topRefresh = b;
    }

    public void onIsRefresh(Boolean b){
        isRefreshable = b & topRefresh;
    }

    @Override
    public void onScroll(AbsListView view, int firstVisibleItem,
                         int visibleItemCount, int totalItemCount) {
        isRefreshable = firstVisibleItem == 0 && !topRefresh;
    }
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case DONE:
                ...
                lvHeaderProgressBar.setVisibility(View.GONE);
                lvHeaderArrowIv.clearAnimation();
           //     lvHeaderArrowIv.setImageResource(R.drawable.lv_header1);
                lvHeaderTipsTv.setText("下拉刷新");
                lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                break;
        }
